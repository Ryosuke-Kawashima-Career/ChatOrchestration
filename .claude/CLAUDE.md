...
- After ANY correction from the user: update `./.claude/specs/lessons.md` with the pattern
...
1. **Plan First**: Write plan to `./.claude/specs/todo.md` with checkable items
2. **Verify Plan**: Check in before starting implementation
3. **Track Progress**: Mark items complete as you go
4. **Explain Changes**: High-level summary at each step
5. **Document Results**: Add review section to `./.claude/specs/todo.md`
6. **Capture Lessons**: Update `./.claude/specs/lessons.md` after corrections
