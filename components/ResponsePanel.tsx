...
export default function ResponsePanel({ provider, model, response, prompt, timestamp }: Props) {
  ...
  return (
    <div className="flex flex-col bg-gray-900 rounded-xl border border-gray-800 overflow-hidden min-h-[200px]">
      {/* Header */}
      ...
      {prompt && timestamp && !streaming && content && !error && (
